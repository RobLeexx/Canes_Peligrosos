        ...
        <template #content>
            ...
            <jet-dialog-modal :show="confirmingLogout" @close="closeModal">
                ...
                <template #footer>
                    ...
                    <jet-button class="ml-2" @click.native="logoutOtherBrowserSessions" :class="{ 'opacity-25': form.processing }" :disabled="form.processing" style="color: white; background: red">
                        Cerrar sesiones
                    </jet-button>
                </template>
            </jet-dialog-modal>
